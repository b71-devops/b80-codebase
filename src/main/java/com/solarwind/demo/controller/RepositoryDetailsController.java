...
public class RepositoryDetailsController {
	...
	public String getRepos() throws IOException {
		GitHub github = new GitHubBuilder().withPassword("somedummyemail@gmail.com", "XXXXXXXX").build();
		GHRepositorySearchBuilder builder = github.searchRepositories();
		return "If you see this page, you have a successfull deployment. Cheers!";
	}
